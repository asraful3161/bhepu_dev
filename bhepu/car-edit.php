...
if(isset($_POST['form1'])) {
	...
	if(empty($_POST['division_id'])) {
		$valid = 0;
		$error_message .= 'You must have to select a division.\n';
	}
	if(empty($_POST['district_id'])) {
		$valid = 0;
		$error_message .= 'You must have to select a district.\n';
	}
									...
									<div class="form-row">
										...
										<div class="form-group col-md-6 col-sm-6 option-item">
											...
											<select data-placeholder="Choose Division..." class="form-control division" name="division_id">
												...
												foreach ($result as $row) {
													?>
													<option value="<?php echo $row['division_id']; ?>" <?php if($row['division_id'] == $division_id){echo 'selected';} ?>><?php echo $row['division_name']; ?></option>
													<?php
												}
												?>
											</select>
										...
										<div class="form-group col-md-6 col-sm-6 option-item">
											...
											<select data-placeholder="Choose District..." class="form-control district" name="district_id">
